...
import { Type, Link as LinkIcon, X, User, Upload, Trash2, Camera } from 'lucide-react';
...
type BadgeTab = 'details' | 'photo' | 'qr';
...
export const Controls: React.FC<ControlsProps> = ({ config, setConfig, isOpen, onClose, isBadgeMode = false }) => {
  ...
  const [activeTab, setActiveTab] = useState<BadgeTab>('details');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center pointer-events-none">
      ...
      {/* Sheet - Mobile optimized height */}
      <div className="bg-white w-full max-w-2xl rounded-t-3xl shadow-2xl pointer-events-auto transform transition-transform duration-300 ease-out flex flex-col max-h-[45vh] md:max-h-[70vh]">
        {/* Header */}
          ...
          <>
            ...
            <div className="flex gap-2 px-6 pb-4 flex-shrink-0">
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all ${activeTab === 'details'
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all ${activeTab === 'photo'
                    ? 'bg-slate-900 text-white shadow-md'
                    : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all ${activeTab === 'qr'
                    ? 'bg-slate-900 text-white shadow-md'
                    : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                  }`}
              >
              ...
              <div className="pb-4">
                ...
                {activeTab === 'details' && (
                  <div className="space-y-4 animate-fade-in">
                    ...
                    <p className="text-xs text-slate-500">
                      This will appear on your badge
                    </p>
                  </div>
                )}
                  ...
                  <div className="space-y-4 animate-fade-in">
                    ...
                    <label className="block">
                      <input
                        ...
                        className="hidden"
                      />
                      <div className="w-full p-6 bg-slate-50 border-2 border-dashed border-slate-300 rounded-2xl hover:border-slate-400 hover:bg-slate-100 transition-all cursor-pointer text-center">
                ...
                {activeTab === 'qr' && (
                  <div className="space-y-4 animate-fade-in">
                    ...
                    />
                    <p className="text-xs text-slate-500">
                      This URL will be encoded in the QR code on your badge
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="p-6 pt-4 flex-shrink-0 border-t border-slate-100">
              <button
                onClick={onClose}
                className="w-full py-4 bg-slate-900 text-white rounded-2xl font-semibold text-lg hover:bg-slate-800 transition-colors shadow-lg active:scale-95"
              >
                Done
              </button>
            </div>
              ...
              <div className="flex p-1 bg-slate-100 rounded-xl">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-3 px-3 rounded-lg text-sm font-medium transition-all ${mode === m.id
